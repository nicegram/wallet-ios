...
private final class WalletInfoHeaderNode: ASDisplayNode {
    ...
    init(presentationData: WalletPresentationData, hasActions: Bool, sendAction: @escaping () -> Void, receiveAction: @escaping () -> Void) {
        ...
        self.balanceSubtitleNode.attributedText = NSAttributedString(string: presentationData.strings.Wallet_Info_YourBalance + " " + gramToFiatStr(self.balance), font: Font.regular(13), textColor: UIColor(white: 1.0, alpha: 0.6))
